...
if(isset($_POST["submit"])){
	...
	$query = "UPDATE materiasimpartidas SET matricula='".$_POST["matricula"]."', clavemateria='".$_POST["clavemateria"]."', ".
...
echo '<a href="ejemodificar.php"><br>Volver</a>';
	...
	$query="SELECT * FROM materiasimpartidas WHERE matricula='".$matricula."'";
	$result=mysql_query($query,$link) or die("Error: ".mysql_error());
